...
export const WhatsappIcon = (props) => baseSvg(
  <>
    <path d="M20.52 3.48A11.85 11.85 0 0 0 12.08 0C5.52 0 .18 5.34.18 11.91c0 2.1.55 4.15 1.6 5.96L.07 24l6.27-1.64a11.9 11.9 0 0 0 5.74 1.47h.01c6.56 0 11.9-5.34 11.9-11.91a11.85 11.85 0 0 0-3.47-8.44z" />
    <path d="M17.35 14.37c-.3-.15-1.78-.88-2.05-.98-.27-.1-.47-.15-.67.15-.2.3-.77.98-.95 1.18-.17.2-.35.22-.65.07-.3-.15-1.25-.46-2.38-1.47-.88-.78-1.47-1.75-1.64-2.05-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.07-.15-.67-1.63-.92-2.23-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.5s1.07 2.9 1.22 3.1c.15.2 2.1 3.21 5.08 4.5.71.31 1.27.49 1.7.63.71.23 1.35.2 1.86.12.57-.09 1.78-.73 2.03-1.43.25-.7.25-1.3.17-1.43-.07-.12-.27-.2-.57-.35z" />
  </>,
  props
);
...
export const MapPinIcon = (props) => baseSvg(
  <>
...
export const NavigationIcon = (props) => baseSvg(
  <>
...
export const PhoneCallIcon = (props) => baseSvg(
  <>
...
export const CompassIcon = (props) => baseSvg(
  <>
    <circle cx="12" cy="12" r="10" />
